...
function theme_almondb_page_init(moodle_page $PAGE) {
   // $PAGE->requires->css('/theme/almondb/style/frontpage.css');
    ...
    $PAGE->requires->css('/theme/almondb/lib/owlcarousel/assets/owl.carousel.min.css');
    $PAGE->requires->css('/theme/almondb/lib/animate/animate.min.css');
    ...
    //$PAGE->requires->js('/theme/almondb/js/bootstrap.bundle.min.js');
    //$PAGE->requires->js('/theme/almondb/lib/wow/wow.min.js');
    //$PAGE->requires->js('/theme/almondb/lib/easing/easing.min.js');
    //$PAGE->requires->js('/theme/almondb/lib/waypoints/waypoints.min.js');
    //$PAGE->requires->js('/theme/almondb/lib/counterup/counterup.min.js');
    //$PAGE->requires->js('/theme/almondb/lib/owlcarousel/owl.carousel.min.js');
    //$PAGE->requires->js('/theme/almondb/js/main.js');
